...
<div id="voicedata-serv-mainhead" style="padding: 200px 0 300px 0;">
    <div class="container text-center">
        ...
        <h1 style="color: aqua; font-size: 40px; margin-top:15px;">Voice Services <i class="fa-solid fa-microphone" style="color:white;"></i></h1>
...
<div id="voicedata-serv-main" style="padding-bottom: 200px; padding-top: 40px;">
        ...
        <div class="container-fluid col-11">
            <div class="row">
                <div class="col-lg-6 col-md-6 col-12 order-1 reveal">
                    <h1 class="voicedata-head display-5"><span class="ban-head-1">Primary Interface</span></h1>
                    <p class="my-lg-2 my-3 mb-5">PRI (Primary Rate Interface) is a fixed line voice service which works on ISDN technology. It offers digital connectivity with scalability. PRI solution has 30 channels providing voice, data, image and video services on a single link. Features - Pilot number , Scalable with multiples of 30 channels , Calling Line Identity Presentation (CLIP)Direct Inward Dialing (DID) and Direct Outward Dialing , Service Level Agreement</p>
                ...
                <div class="col-lg-6 col-md-6 col-12 py-lg-0 py-3 reveal1">
                    <img src="./assets/img/voice_data/voice_serv/primary_interface.webp" style="border-radius: 20px;" alt="Primary_Interface" class="img-fluid">
                </div>
            </div>
        </div>
    </div><br>
        ...
        <div class="container">
            <div class="row">
                <div class="col-lg-6 col-md-6 col-12 py-lg-0 py-3 order-sm-2 reveal">
                    <img src="./assets/img/voice_data/voice_serv/centrex.webp" style="float: right; border-radius: 20px;" alt="Centrex" class="img-fluid">
                </div>
                <div class="col-lg-6 col-md-6 col-12 reveal1">
                    <h1 class="voicedata-head display-5"><span class="ban-head-1">Centrex</span></h1>
                    <p>Centrex Seamlessly Connect All Your Offices. Fully managed tele communication service, be it at new premises or while replacing / enhancing an existing system, with minimal or no capital expenditure. IP Centrex connectivity simulates an EPABX to provide features of an advanced EPABX without investing in one. Services like Call Hold, Call Line Identification, Call Forwarding , Authentication Code to Prevent Unauthorised Use etc available.</p>
                    <button class="req-callback reveal3"><a href="contact.php" style="text-decoration: none; color: white;"><i class="fa-solid fa-phone fa-beat fa-xl"></i>&nbsp; Request Callback</a></button>
                </div>  
            </div>
        </div>
    ...
    <div id="voicedata-serv" style="padding-top: 60px;">
        <div class="container">
            <div class="row">
                <div class="col-lg-6 col-md-6 col-12 order-1 reveal">
                    <h1 class="voicedata-head display-5"><span class="ban-head-1">SIP Trunk</span></h1>
                    <p class="my-lg-2 my-3 mb-5">Session Initiation Protocol (SIP) solution is an advanced voice connectivity product, with the best-in-class IP solution which replaces traditional multiple fixed PSTN lines with a single physical link that can support up to 1500 simultaneous calls. It is easy and cost-effective to scale by reducing need for maintenance and additional hardware.</p>
                    <button class="req-callback reveal3"><a href="contact.php" style="text-decoration: none; color: white;"><i class="fa-solid fa-phone fa-beat fa-xl"></i>&nbsp; Request Callback</a></button>
                </div>
                <div class="col-lg-6 col-md-6 col-12 py-lg-0 py-3 reveal1">
                    <img src="./assets/img/voice_data/voice_serv/sip_trunk.webp" style="border-radius: 20px;" alt="SIP_Trunk" class="img-fluid">
                </div>
            </div>
        </div>
    </div>
