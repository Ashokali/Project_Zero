...
<!------ Saas section start ------>
<div id="software-serv-mainhead" style="padding: 200px 0 300px 0;">
    <div class="container text-center">
        ...
        <h1 style="color: aqua; font-size: 40px; margin-top:10px;">SAAS <i class="fa-solid fa-file-invoice" style="color:white;"></i></h1>
...
<div id="software-serv-main" style="padding-bottom: 100px; padding-top: 40px;">
    <div id="software-serv" style="padding-top: 40px;">
        <div class="container-fluid col-11">
            <div class="row">
                <div class="softmain-anim col-lg-6 col-md-6 col-12 order-1 reveal">
                    <h1 class="soft-head display-5"><span class="ban-head-1">Microsoft 365</span></h1>
                    <p class="my-lg-2 my-3 mb-5">Microsoft 365 is a subscription service that provides access to a suite of applications and services that help you work and collaborate across devices and platforms1. Includes : Office apps: You can use Word, Excel, PowerPoint, Outlook, and other apps that are enhanced with artificial intelligence and cloud capabilities. </p>
                ...
                <div class="col-lg-6 col-md-6 col-12 py-lg-0 py-3 reveal1">
                    <img src="./assets/img/software_serv/saas/microsoft_365.webp" style="border-radius: 20px;" alt="Microsoft_365" class="img-fluid">
                </div>
            </div>
        </div>
    </div><br>
        ...
        <div class="container">
            <div class="row">
                <div class="col-lg-6 col-md-6 col-12 py-lg-0 py-3 order-sm-2 reveal">
                    <img src="./assets/img/software_serv/saas/microsoft_azure.webp" style="float: right; border: 2px solid white; border-radius: 20px;" alt="Microsoft_Azure" class="img-fluid">
                </div>
                <div class="col-lg-6 col-md-6 col-12 reveal1">
                    <h1 class="soft-head display-5"><span class="ban-head-1">Microsoft Azure</span></h1>
                    <p>The Azure cloud platform is more than 200 products and cloud services designed to help you bring new solutions to life—to solve today’s challenges and create the future. Build, run and manage applications across multiple clouds, on-premises and at the edge, with the tools and frameworks of your choice. </p>
                    <button class="req-callback reveal3"><a href="contact.php" style="text-decoration: none; color: white;"><i class="fa-solid fa-phone fa-beat fa-xl"></i>&nbsp; Request Callback</a></button>
                </div>  
            </div>
        </div>
        ...
        <div class="container">
            <div class="row">
                <div class="col-lg-6 col-md-6 col-12 order-1 reveal">
                    <h1 class="soft-head display-5"><span class="ban-head-1">Smart Flo</span></h1>
                    <p class="my-lg-2 my-3 mb-5">Smartflo’s communication services enable entrepreneurs’ vision to extend beyond their cubicles, to work more efficiently from anywhere they choose to. Backed by TTBS, Smartflo comes with a guarantee of 99.5%. The cloud communication platform ensures uninterrupted business continuity. It equally appeals to all sizes of business enterprises that need multi-modal, multi-functional, economic, and advanced cloud communication services.</p>
                    <button class="req-callback reveal3"><a href="contact.php" style="text-decoration: none; color: white;"><i class="fa-solid fa-phone fa-beat fa-xl"></i>&nbsp; Request Callback</a></button>
                </div>
                <div class="col-lg-6 col-md-6 col-12 py-lg-0 py-3 reveal1">
                    <img src="./assets/img/software_serv/saas/smart_flo.webp" style="border-radius: 20px;" alt="Smart_Flo" class="img-fluid">
                </div>
            </div>
        </div>
    </div><br>
    ...
    <div id="software-serv" style="padding-top: 60px;">
        <div class="container">
            <div class="row">
                <div class="col-lg-6 col-md-6 col-12 py-lg-0 py-3 order-sm-2 reveal">
                    <img src="./assets/img/software_serv/saas/crm.webp" style="float: right; border-radius: 20px;" alt="CRM" class="img-fluid">
                </div>
                <div class="col-lg-6 col-md-6 col-12 reveal1">
                    <h1 class="soft-head display-5"><span class="ban-head-1">CRM</span></h1>
                    <p class="my-lg-2 my-3 mb-5">Contact center software to provide inbound, outbound and blended call handling and email support.  Web-based agent and administrative interfaces , Predictive, broadcast and agent-controlled dialing Integrated call recording and monitoring ,  Web-configurable IVRs and voicemail boxes</p>
                    <button class="req-callback reveal3"><a href="contact.php" style="text-decoration: none; color: white;"><i class="fa-solid fa-phone fa-beat fa-xl"></i>&nbsp; Request Callback</a></button>
                </div>  
            </div>
        </div>
